...
(function() {
    ...
    LicenseController.$inject = ['$scope', '$filter', 'ngTableParams', '$stateParams', '$state', 'storageService', 'errorHandle', 'licenseService', '$timeout', '$sce', 'DialogFactory', 'bsLoadingOverlayService'];

    function LicenseController($scope, $filter, ngTableParams, $stateParams, $state, storageService, errorHandle, licenseService, $timeout, $sce, DialogFactory, bsLoadingOverlayService) {
            ...
            result.then(function(response) {
                ...
                function(errorResponse) {
                    ...
                    if (errorResponse.status === 417) {
                        ...
                        message = "Lisensi ini sudah terpakai, silahkan hubungi IT support kami untuk melakukan <a ng-click='gotoManual()'><b>Aktivasi Manual</b></a>";
                    }
