// Generated on 2017-10-05 using generator-angular 0.16.0
'use strict';
...
var paths = {
    ...
    styles: [yeoman.app + '/styles/**/*.scss', yeoman.app + '/styles/**/*.css'],
    test: ['test/spec/**/*.js'],
    testRequire: [
...
gulp.task('build', ['clean:dist'], function() {
    runSequence(['images', 'template-data', 'copy:plugins', 'copy:extras', 'copy:fonts', 'client:build']);
});
